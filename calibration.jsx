...
(function () {
  ...
  const Remote = {
    ...
    loadAudits: async () => {
      ...
      all.forEach(a => {
        if (a.ts == null) a.ts = new Date(a.callDate || 0).getTime() || 0;
        if (!a.auditorRole) a.auditorRole = Q.roleForEmail(a.auditorEmail || '');
      });
    ...
    return {
      ...
      saveAudit: (p) => {
        ...
        const rec = {
          ...
          auditorRole: p.auditorRole || Q.roleForEmail(p.auditorEmail || ''),
